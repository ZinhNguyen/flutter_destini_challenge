...
//TODO: Step 8 - Create a method called getStory() that returns the first storyTitle from _storyData.
  String getStory() {
    return _storyData[_storeNumber].storyTitle;
  }

//TODO: Step 11 - Create a method called getChoice1() that returns the text for the first choice1 from _storyData.
  String getChoice1() {
    return _storyData[_storeNumber].choice1;
  }

//TODO: Step 12 - Create a method called getChoice2() that returns the text for the first choice2 from _storyData.
  String getChoice2() {
    return _storyData[_storeNumber].choice2;
  }
...
//TODO: Step 17 - Create a method called nextStory(), it should not have any outputs but it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
  void nextStory(int usersChoice) {
    if (usersChoice == 1 && _storeNumber == 0) {
      _storeNumber = 2;
    } else if (usersChoice == 2 && _storeNumber == 0) {
      _storeNumber = 1;
    } else if (usersChoice == 1 && _storeNumber == 2) {
      _storeNumber = 5;
    } else if (usersChoice == 2 && _storeNumber == 2) {
      _storeNumber = 4;
    } else if (usersChoice == 1 && _storeNumber == 1) {
      _storeNumber = 2;
    } else if (usersChoice == 2 && _storeNumber == 1) {
      _storeNumber = 3;
    } else if (_storeNumber == 3 || _storeNumber == 4 || _storeNumber == 5) {
      restart();
    }
  }
